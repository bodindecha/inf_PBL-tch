<?php
	...
	function is_branch_head() {
		global $APP_USER, $APP_DB, $TCL;
		if (empty($APP_USER) || !isset($_SESSION["stif"]["t_year"])) $TCL -> http_response_code(907);
	...
	} if (!has_perm("PBL") && !is_branch_head()) $TCL -> http_response_code(901);
	$APP_DB[0] -> close();
?>
<!doctype html>
